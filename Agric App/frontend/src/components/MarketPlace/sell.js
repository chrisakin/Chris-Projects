            ...
            <div>
                <div className="bg">
                    <div className='jumbo-wrapper'>
                        <div className='text'>
                            <a className='title'>GET STARTED<br />SELLING WITH FARMLY.</a>
                            <a className='description'>Apply to be a Farmly seller for the possibility of showcasing your harvest and generating additional income</a>
